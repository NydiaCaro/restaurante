...
<div id="quienes somos" class="about-bottom">
    ...
    <div class="container">
      ...
      <div class="about-bottom-grids">
        <div class="col-md-12 about-bottom-left">
          <h2>Empresa</h2>
      ...
      <div class="gallery-grids-top">
        <div class="gallery-grids">
          <div class="col-md-12 gallery-right">
            <div class="col-md-12 mix-info text-center">
...
<div class="col-md-6 gallery-grid middle-gallery-grid">
  ...
  <div class="contact-top">
    ...
    <div class="mail-grids">
      <div class="col-md-6 contact-form">
       ...
       <?php echo do_shortcode('[bookingtimeline view_days_num=90 booking nummonths=2]') ?>
      </div>
      <div class="col-md-6 reserva">
        <h3 id="reservar" class="title1">Reserva con Nosotros:</h3>
    
        <h5>(*) Condiciones de Reserva</h5>
